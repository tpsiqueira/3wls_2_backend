...
import django
from prod_app.models import ativo, poco, uep, uo
from django.contrib.auth.decorators import login_required, user_passes_test
from django.contrib.auth.models import User
from django.http import HttpResponse
from django.shortcuts import render

from prod_app.services.piservice import prepare_pi_data_req, run_batch
...
from django.http import HttpResponse
from prod_app.models import amostra, analise
...
def verificar_superuser_ou_admin(user):
    return user.is_superuser or user.groups.filter(name="Administrador").exists()
...
def ajax_coletar_dados_variaveis_entrada(request):
  ...
  if request.headers.get("x-requested-with") == "XMLHttpRequest" and request.POST:
      IntervaloAmostragem = request.POST["IntervaloAmostragem"]
